    ...
    <div class="lg:col-span-3 space-y-4">
        ...
        <div class="bg-white p-3 rounded-2xl border border-slate-200/80 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-3">
            <div class="relative w-full sm:max-w-md">
                <input type="text" wire:model.live.debounce.300ms="search" placeholder="Search by title, keywords, or skills..." class="w-full pl-10 pr-10 py-2 text-sm rounded-xl border border-slate-200 text-slate-900 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition">
                ...
                @if($search)
                    <button wire:click="$set('search', '')" class="absolute inset-y-0 right-2 flex items-center text-slate-400 hover:text-slate-700 transition" title="Clear search">
